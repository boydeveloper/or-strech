...
import style from "./IntraoperativeStanding.module.css";
function IntraoperativeStanding() {
  return (
    <div>
      <Navbar />
      <div className="container">
        <div className={style.IntraoperativeStandingWrapper}>
          <header>
            <h1>IntraOperative standing</h1>
            <p>Within surgery standing – Quick cues</p>
          </header>
          <main>
            <div className={style.excercise}>
              <div className={style.textbox}>
                ...
                <div className={style.procedures}>
                  <li>Base position</li>
                  <li>Stand balanced</li>
                  <li>Feet shoulder width apart</li>
                  <li>Fingers interlaced at the level of your belly button </li>
                </div>
              </div>
              <div className={style.img_box}>
                <img src="/assets/imgs/baseposition.png" alt="base position" />
              </div>
            </div>
            <div className={style.excercise}>
              <div className={style.img_box}>
            ...
            <div className={style.excercise}>
              ...
              <div className={style.img_box}>
                <img
                  src="/assets/imgs/shouldershrug.png"
                  alt="shoulder shrug"
                />
              </div>
            </div>
            <div className={style.excercise}>
              <div className={style.img_box}>
                <img src="/assets/imgs/pushaway.png" alt="push away" />
              </div>
              <div className={style.textbox}>
                ...
                <div className={style.procedures}>
                  ...
                  <li>
                    Return your hands to your chest. Pinch shoulder blades
                    together as hands return to chest.
                  </li>
                  <li>
                  ...
                  <li>Then back to base position</li>
                </div>
              </div>
            </div>
            ...
            <div className={style.excercise}>
              <div className={style.textbox}>
                ...
                <div className={style.procedures}>
                  <li>Lift your face toward the ceiling dropping head back</li>
                  <li>Deep breath in</li>
              ...
              <div className={style.img_box}>
                <img
                  src="/assets/imgs/neckextension.png"
                  alt="neck extension"
                />
              </div>
            </div>
...
export default IntraoperativeStanding;
